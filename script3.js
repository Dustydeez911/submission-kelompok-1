...
document.addEventListener("DOMContentLoaded", function () {
  // Nama buku yang ingin ditampilkan
  let nama = "Sejarah Dunia"; // Ganti dengan nama buku yang diinginkan
  ...
  img.src = imgSrc; // Menentukan sumber gambar
  img.alt = "Cover " + nama; // Alt text untuk gambar
  img.style.width = "120px"; // Ukuran lebar gambar
  img.style.height = "180px"; // Ukuran tinggi gambar
  ...
  judul.textContent = nama; // Mengatur teks judul sesuai nama buku
  ...
  btn.addEventListener("click", function () {
    ...
    container.innerHTML = ""; // Menghapus konten di dalam container
